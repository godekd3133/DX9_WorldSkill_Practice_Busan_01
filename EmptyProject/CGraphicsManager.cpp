...
CSprite * CGraphicsManager::AddSprite(string _Path, string _Key)
{
	...
	else return FindSprite(_Key);
	return nullptr;
}

CMesh * CGraphicsManager::AddMesh(string _Path, string _Key, string _MapPath)
{
	if (FindSprite(_Key) == nullptr)
	{
